...
cufinufft_opts build_opts(int64_t modeord, double upsampfac, int64_t gpu_method, int64_t gpu_sort,
                          int64_t gpu_binsizex, int64_t gpu_binsizey, int64_t gpu_binsizez,
                          int64_t gpu_obinsizex, int64_t gpu_obinsizey, int64_t gpu_obinsizez,
                          int64_t gpu_maxsubprobsize, int64_t gpu_np, int64_t gpu_kerevalmeth,
                          int64_t gpu_spreadinterponly, int64_t gpu_maxbatchsize, int64_t debug) {
  cufinufft_opts opts;
  default_opts<T>(&opts);
  ...
  opts.gpu_binsizex = static_cast<int>(gpu_binsizex);
  opts.gpu_binsizey = static_cast<int>(gpu_binsizey);
  opts.gpu_binsizez = static_cast<int>(gpu_binsizez);
  opts.gpu_obinsizex = static_cast<int>(gpu_obinsizex);
  opts.gpu_obinsizey = static_cast<int>(gpu_obinsizey);
  opts.gpu_obinsizez = static_cast<int>(gpu_obinsizez);
  opts.gpu_maxsubprobsize = static_cast<int>(gpu_maxsubprobsize);
  opts.gpu_np = static_cast<int>(gpu_np);
  opts.gpu_kerevalmeth = static_cast<int>(gpu_kerevalmeth);
  opts.gpu_spreadinterponly = static_cast<int>(gpu_spreadinterponly);
...
ffi::Error nufft1_impl(cudaStream_t stream, T eps, int64_t iflag, int64_t n_tot, int64_t n_transf,
  ...
  cufinufft_opts opts =
      build_opts<T>(modeord, upsampfac, gpu_method, gpu_sort, gpu_binsizex, gpu_binsizey,
                    gpu_binsizez, gpu_obinsizex, gpu_obinsizey, gpu_obinsizez, gpu_maxsubprobsize,
                    gpu_np, gpu_kerevalmeth, gpu_spreadinterponly, gpu_maxbatchsize, debug);
...
ffi::Error nufft3_impl(cudaStream_t stream, T eps, int64_t iflag, int64_t n_tot, int64_t n_transf,
                       ...
                       int64_t gpu_obinsizex, int64_t gpu_obinsizey, int64_t gpu_obinsizez,
                       int64_t gpu_maxsubprobsize, int64_t gpu_np, int64_t gpu_kerevalmeth,
                       int64_t gpu_maxbatchsize, int64_t debug, int64_t gpu_spreadinterponly,
                       ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
...
ffi::Error nufft1d1f_impl(cudaStream_t stream, float eps, int64_t iflag, int64_t n_tot,
                          ...
                          int64_t gpu_sort, int64_t gpu_binsizex, int64_t gpu_binsizey,
                          int64_t gpu_binsizez, int64_t gpu_obinsizex, int64_t gpu_obinsizey,
                          int64_t gpu_obinsizez, int64_t gpu_maxsubprobsize, int64_t gpu_np,
                          int64_t gpu_kerevalmeth, int64_t gpu_spreadinterponly,
                          int64_t gpu_maxbatchsize, int64_t debug, ffi::AnyBuffer source,
                          ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
                          ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft1_impl<1, float>(
      stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord, upsampfac,
      gpu_method, gpu_sort, gpu_binsizex, gpu_binsizey, gpu_binsizez, gpu_obinsizex, gpu_obinsizey,
      gpu_obinsizez, gpu_maxsubprobsize, gpu_np, gpu_kerevalmeth, gpu_spreadinterponly,
      gpu_maxbatchsize, debug, source, points_x, points_y, points_z, output);
}
...
ffi::Error nufft1d3f_impl(
    cudaStream_t stream, float eps, int64_t iflag, int64_t n_tot, int64_t n_transf, int64_t n_j,
    int64_t n_k_1, int64_t n_k_2, int64_t n_k_3, int64_t modeord, double upsampfac,
    int64_t gpu_method, int64_t gpu_sort, int64_t gpu_binsizex, int64_t gpu_binsizey,
    int64_t gpu_binsizez, int64_t gpu_obinsizex, int64_t gpu_obinsizey, int64_t gpu_obinsizez,
    int64_t gpu_maxsubprobsize, int64_t gpu_np, int64_t gpu_kerevalmeth, int64_t gpu_maxbatchsize,
    int64_t debug, int64_t gpu_spreadinterponly, ffi::AnyBuffer source, ffi::AnyBuffer points_x,
  ...
  return nufft3_impl<1, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3,
                               modeord, upsampfac, gpu_method, gpu_sort, gpu_binsizex,
                               gpu_binsizey, gpu_binsizez, gpu_obinsizex, gpu_obinsizey,
                               gpu_obinsizez, gpu_maxsubprobsize, gpu_np, gpu_kerevalmeth,
                               gpu_maxbatchsize, debug, gpu_spreadinterponly, source, points_x,
