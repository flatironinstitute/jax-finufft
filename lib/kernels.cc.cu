...
ffi::Error run_nufft(cudaStream_t stream, cufinufft_opts opts, T eps, int iflag,
                     int64_t n_tot, int n_transf, int64_t n_j,
                     const int64_t* n_k, T* x, T* y, T* z, std::complex<T>* c,
                     T* s, T* t, T* u, std::complex<T>* F) {
  int64_t n_k_total = 1;
  if constexpr (type != 3) {
  ...
  int ret = makeplan<T>(type, ndim, n_k_mutable, iflag, n_transf, eps, &plan,
                        &opts);
  // ret == 1 is FINUFFT_WARN_EPS_TOO_SMALL (warning, not error)
  if (ret > 1) {
    return ffi::Error::Internal("cuFINUFFT makeplan failed with code " +
                                std::to_string(ret));
  }
  ...
  for (int64_t index = 0; index < n_tot; ++index) {
    ...
    if (ret != 0) {
      destroy<T>(plan);
      return ffi::Error::Internal("cuFINUFFT setpts failed with code " +
                                  std::to_string(ret));
    }
    ...
    if (ret != 0) {
      destroy<T>(plan);
      return ffi::Error::Internal("cuFINUFFT execute failed with code " +
                                  std::to_string(ret));
    }
  }
  ...
  if (cuda_err != cudaSuccess) {
    return ffi::Error::Internal("CUDA error: " +
                                std::string(cudaGetErrorString(cuda_err)));
  }
...
template <typename T>
cufinufft_opts build_opts(int64_t modeord, double upsampfac, int64_t gpu_method,
                          int64_t gpu_sort, int64_t gpu_kerevalmeth,
...
ffi::Error nufft1_impl(
    cudaStream_t stream, T eps, int64_t iflag, int64_t n_tot, int64_t n_transf,
  ...
  cufinufft_opts opts =
      build_opts<T>(modeord, upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth,
  ...
  return run_nufft<ndim, T, 1>(stream, opts, eps, static_cast<int>(iflag),
                               n_tot, static_cast<int>(n_transf), n_j, n_k, x,
                               y, z, c, nullptr, nullptr, nullptr, F);
}
...
ffi::Error nufft2_impl(
  ...
  return run_nufft<ndim, T, 2>(stream, opts, eps, static_cast<int>(iflag),
                               n_tot, static_cast<int>(n_transf), n_j, n_k, x,
                               y, z, c, nullptr, nullptr, nullptr, F);
}
...
ffi::Error nufft3_impl(
  ...
  return run_nufft<ndim, T, 3>(stream, opts, eps, static_cast<int>(iflag),
                               n_tot, static_cast<int>(n_transf), n_j, n_k, x,
                               y, z, c, s, t, u, F);
}
...
ffi::Error nufft1d1f_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft1_impl<1, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               output);
}
...
ffi::Error nufft1d1_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft1_impl<1, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                output);
...
ffi::Error nufft2d1f_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft1_impl<2, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               output);
...
ffi::Error nufft2d1_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft1_impl<2, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                output);
...
ffi::Error nufft3d1f_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft1_impl<3, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               output);
...
ffi::Error nufft3d1_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft1_impl<3, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                output);
...
ffi::Error nufft1d2f_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft2_impl<1, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               output);
...
ffi::Error nufft1d2_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft2_impl<1, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                output);
...
ffi::Error nufft2d2f_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft2_impl<2, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               output);
...
ffi::Error nufft2d2_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft2_impl<2, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                output);
...
ffi::Error nufft3d2f_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft2_impl<3, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               output);
...
ffi::Error nufft3d2_impl(
    ...
    ffi::AnyBuffer source, ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
    ffi::AnyBuffer points_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft2_impl<3, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                output);
...
ffi::Error nufft1d3f_impl(
    ...
    ffi::AnyBuffer points_z, ffi::AnyBuffer target_x, ffi::AnyBuffer target_y,
    ffi::AnyBuffer target_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft3_impl<1, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
...
ffi::Error nufft1d3_impl(
    ...
    ffi::AnyBuffer points_z, ffi::AnyBuffer target_x, ffi::AnyBuffer target_y,
    ffi::AnyBuffer target_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft3_impl<1, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                target_x, target_y, target_z, output);
...
ffi::Error nufft2d3f_impl(
    ...
    ffi::AnyBuffer points_z, ffi::AnyBuffer target_x, ffi::AnyBuffer target_y,
    ffi::AnyBuffer target_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft3_impl<2, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               target_x, target_y, target_z, output);
...
ffi::Error nufft2d3_impl(
    ...
    ffi::AnyBuffer points_z, ffi::AnyBuffer target_x, ffi::AnyBuffer target_y,
    ffi::AnyBuffer target_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft3_impl<2, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                target_x, target_y, target_z, output);
...
ffi::Error nufft3d3f_impl(
    ...
    ffi::AnyBuffer points_z, ffi::AnyBuffer target_x, ffi::AnyBuffer target_y,
    ffi::AnyBuffer target_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft3_impl<3, float>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                               n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                               gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                               debug, source, points_x, points_y, points_z,
                               target_x, target_y, target_z, output);
...
ffi::Error nufft3d3_impl(
    ...
    ffi::AnyBuffer points_z, ffi::AnyBuffer target_x, ffi::AnyBuffer target_y,
    ffi::AnyBuffer target_z, ffi::Result<ffi::AnyBuffer> output) {
  return nufft3_impl<3, double>(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1,
                                n_k_2, n_k_3, modeord, upsampfac, gpu_method,
                                gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize,
                                debug, source, points_x, points_y, points_z,
                                target_x, target_y, target_z, output);
