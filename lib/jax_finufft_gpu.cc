...
inline auto MakeNufft1dBinding12Float() {
  return ffi::Ffi::Bind()
      .Ctx<ffi::PlatformStream<cudaStream_t>>() NUFFT_COMMON_ATTRS_FLOAT.Arg<ffi::AnyBuffer>()
      .Arg<ffi::AnyBuffer>()
      .Arg<ffi::AnyBuffer>()
      .Ret<ffi::AnyBuffer>();
}
...
inline auto MakeNufft1dBinding12Double() {
  return ffi::Ffi::Bind()
      .Ctx<ffi::PlatformStream<cudaStream_t>>() NUFFT_COMMON_ATTRS_DOUBLE.Arg<ffi::AnyBuffer>()
      .Arg<ffi::AnyBuffer>()
      .Arg<ffi::AnyBuffer>()
      .Ret<ffi::AnyBuffer>();
}
...
ffi::Error nufft1d1f_1d_wrapper(cudaStream_t stream, float eps, int64_t iflag, int64_t n_tot,
  ...
  return nufft1d1f_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                        ...
                        source, points_mask, points_x, points_x, points_x, output);
}
...
ffi::Error nufft2d1f_2d_wrapper(cudaStream_t stream, float eps, int64_t iflag, int64_t n_tot,
  ...
  return nufft2d1f_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                        upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize, debug,
                        source, points_mask, points_x, points_y, points_x, output);
}
...
ffi::Error nufft3d1f_3d_wrapper(cudaStream_t stream, float eps, int64_t iflag, int64_t n_tot,
                                int64_t n_transf, int64_t n_j, int64_t n_k_1, int64_t n_k_2,
                                int64_t n_k_3, int64_t modeord, double upsampfac,
                                int64_t gpu_method, int64_t gpu_sort, int64_t gpu_kerevalmeth,
                                int64_t gpu_maxbatchsize, int64_t debug, ffi::AnyBuffer source,
                                ...
                                ffi::Result<ffi::AnyBuffer> output) {
  return nufft3d1f_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                        upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize, debug,
                        source, points_mask, points_x, points_y, points_z, output);
}

ffi::Error nufft3d1_3d_wrapper(cudaStream_t stream, double eps, int64_t iflag, int64_t n_tot,
                               int64_t n_transf, int64_t n_j, int64_t n_k_1, int64_t n_k_2,
                               int64_t n_k_3, int64_t modeord, double upsampfac,
                               int64_t gpu_method, int64_t gpu_sort, int64_t gpu_kerevalmeth,
                               int64_t gpu_maxbatchsize, int64_t debug, ffi::AnyBuffer source,
                               ...
                               ffi::AnyBuffer points_y, ffi::AnyBuffer points_z,
                               ffi::Result<ffi::AnyBuffer> output) {
  return nufft3d1_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                       upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize, debug,
                       source, points_mask, points_x, points_y, points_z, output);
}

ffi::Error nufft3d2f_3d_wrapper(cudaStream_t stream, float eps, int64_t iflag, int64_t n_tot,
                                int64_t n_transf, int64_t n_j, int64_t n_k_1, int64_t n_k_2,
                                int64_t n_k_3, int64_t modeord, double upsampfac,
                                int64_t gpu_method, int64_t gpu_sort, int64_t gpu_kerevalmeth,
                                int64_t gpu_maxbatchsize, int64_t debug, ffi::AnyBuffer source,
                                ...
                                ffi::AnyBuffer points_y, ffi::AnyBuffer points_z,
                                ffi::Result<ffi::AnyBuffer> output) {
  return nufft3d2f_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                        upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize, debug,
                        source, points_mask, points_x, points_y, points_z, output);
}

ffi::Error nufft3d2_3d_wrapper(cudaStream_t stream, double eps, int64_t iflag, int64_t n_tot,
                               int64_t n_transf, int64_t n_j, int64_t n_k_1, int64_t n_k_2,
                               int64_t n_k_3, int64_t modeord, double upsampfac,
                               int64_t gpu_method, int64_t gpu_sort, int64_t gpu_kerevalmeth,
                               int64_t gpu_maxbatchsize, int64_t debug, ffi::AnyBuffer source,
                               ...
                               ffi::AnyBuffer points_y, ffi::AnyBuffer points_z,
                               ffi::Result<ffi::AnyBuffer> output) {
  return nufft3d2_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                       upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize, debug,
                       source, points_mask, points_x, points_y, points_z, output);
}

ffi::Error nufft3d3f_3d_wrapper(cudaStream_t stream, float eps, int64_t iflag, int64_t n_tot,
                                int64_t n_transf, int64_t n_j, int64_t n_k_1, int64_t n_k_2,
                                int64_t n_k_3, int64_t modeord, double upsampfac,
                                int64_t gpu_method, int64_t gpu_sort, int64_t gpu_kerevalmeth,
                                int64_t gpu_maxbatchsize, int64_t debug, ffi::AnyBuffer source,
                                ffi::AnyBuffer points_x, ffi::AnyBuffer points_y,
                                ffi::AnyBuffer points_z, ffi::AnyBuffer target_x,
                                ffi::AnyBuffer target_y, ffi::AnyBuffer target_z,
                                ffi::Result<ffi::AnyBuffer> output) {
  return nufft3d3f_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                        upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize, debug,
                        source, points_x, points_y, points_z, target_x, target_y, target_z,
                        output);
}

ffi::Error nufft3d3_3d_wrapper(cudaStream_t stream, double eps, int64_t iflag, int64_t n_tot,
                               int64_t n_transf, int64_t n_j, int64_t n_k_1, int64_t n_k_2,
                               int64_t n_k_3, int64_t modeord, double upsampfac,
                               int64_t gpu_method, int64_t gpu_sort, int64_t gpu_kerevalmeth,
                               int64_t gpu_maxbatchsize, int64_t debug, ffi::AnyBuffer source,
                               ...
                               ffi::AnyBuffer target_y, ffi::AnyBuffer target_z,
                               ffi::Result<ffi::AnyBuffer> output) {
  return nufft3d3_impl(stream, eps, iflag, n_tot, n_transf, n_j, n_k_1, n_k_2, n_k_3, modeord,
                       upsampfac, gpu_method, gpu_sort, gpu_kerevalmeth, gpu_maxbatchsize, debug,
                       source, points_x, points_y, points_z, target_x, target_y, target_z, output);
}
