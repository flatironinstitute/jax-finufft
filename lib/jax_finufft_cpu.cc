...
finufft_opts setup_opts(int64_t modeord, int64_t debug, int64_t spread_debug, int64_t showwarn,
                        int64_t nthreads, int64_t fftw, int64_t spread_sort, double upsampfac,
...
ffi::Error nufft1d1_wrapper(T eps, int64_t iflag, int64_t n_tot, int64_t n_transf, int64_t n_j,
                            ...
                            int64_t maxbatchsize, int64_t spread_nthr_atomic,
                            int64_t spread_max_sp_size, int64_t spreadinterponly,
                            int64_t allow_eps_too_small, ffi::AnyBuffer source,
  ...
  auto opts = setup_opts<T>(modeord, debug, spread_debug, showwarn, nthreads, fftw, spread_sort,
                            upsampfac, maxbatchsize, spread_nthr_atomic, spread_max_sp_size,
                            spreadinterponly, allow_eps_too_small);
...
// 3D Type 1 wrapper (points_x, points_y, points_z)
template <typename T>
